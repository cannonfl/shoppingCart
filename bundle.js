...
"use strict";
eval("\n\nmodule.exports.addToCart = function (book) {\n  return {\n    type: 'ADD_TO_CART',\n    payload: book\n  };\n};\n\n//# sourceURL=webpack:///./src/actions/cartAction.js?");
...
"use strict";
eval("\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nmodule.exports.booksReducers = function () {\n  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { books: [] };\n  var action = arguments[1];\n\n  var currentBooks = void 0;\n  var index = 0;\n  switch (action.type) {\n    case \"POST_BOOK\":\n      return { books: [].concat(_toConsumableArray(state.books), _toConsumableArray(action.payload)) //concat arrays using spread op; return updated state\n      };break;\n    case \"DELETE_BOOK\":\n      currentBooks = [].concat(_toConsumableArray(state.books));\n      index = currentBooks.findIndex(function (book) {\n        return book.id === action.payload.id;\n      });\n      return { books: [].concat(_toConsumableArray(currentBooks.slice(0, index)), _toConsumableArray(currentBooks.slice(index + 1))) };\n      break;\n    case \"UPDATE_BOOK\":\n      currentBooks = [].concat(_toConsumableArray(state.books));\n      index = currentBooks.findIndex(function (book) {\n        return book.id === action.payload.id;\n      });\n      var updateBook = currentBooks[index].title = action.payload.title;\n      return { books: [].concat(_toConsumableArray(currentBooks.slice(0, index)), [updateBook], _toConsumableArray(currentBooks.slice(index + 1))) };\n      break;\n  }\n  return state;\n};\n\n//# sourceURL=webpack:///./src/reducers/booksReducers.js?");
...
"use strict";
eval("\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nmodule.exports.cartReducers = function () {\n  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { cart: [] };\n  var action = arguments[1];\n\n  switch (action.type) {\n    case \"ADD_TO_CART\":\n      return { cart: [].concat(_toConsumableArray(state.cart), _toConsumableArray(action.payload)) //concat arrays using spread op; return updated state\n      };break;\n  }\n  return state;\n};\n\n//# sourceURL=webpack:///./src/reducers/cartReducers.js?");
